...
def review_list(request):
    ...
    return render(request, 'web/review_list.html', context)


def review_detail(request, review_id):
    review = get_object_or_404(Review, pk=review_id)
    return render(request, 'web/review_detail.html', {'review': review})
...
def add_review(request, product_id):
    ...
    return render(request, 'web/product_detail.html', {'product': product, 'form': form})
...
def faq_detail(request):
    ...
    return render(request, 'web/faq_detail.html', context)
